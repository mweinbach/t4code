...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "T4 Code (Dev)" : "T4 Code";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.mweinbach.t4code.dev.${devBundleIdSuffix || "local"}`
  : "com.mweinbach.t4code";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["t4code-dev"] : ["t4code"];
