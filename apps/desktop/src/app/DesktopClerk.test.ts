...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t4code-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, ["setPath:userData:/tmp/app-data/t4code-dev", "createClerkBridge"]);
  ...
  it.each([
    { isDevelopment: true, scheme: "t4code-dev" },
    { isDevelopment: false, scheme: "t4code" },
